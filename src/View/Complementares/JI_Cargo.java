 ...
 * @author Lucas
 */
public class JI_Cargo extends javax.swing.JInternalFrame {
   ...
   Cadastro_FuncionarioVO ModFuncionario = new Cadastro_FuncionarioVO();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTextFieldcargo, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        ModFuncionario.setNome_Cargo(jTextFieldcargo.getText());

        ControlFuncionario.Cadastrar_Cargo(ModFuncionario);
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        if(jTextFieldCodigo.getText().equals("")){
            ...
            PreencherTabela_Cargo("select * from cargo where Nome_Cargo like'%"+ModFuncionario.getNome_Cargo()+"%'");

            ControlFuncionario.Consultar_NomeCargo(ModFuncionario);

            jTextFieldCodigo.setText(String.valueOf(ModFuncionario.getIdCargo()));
            jTextFieldcargo.setText(String.valueOf(ModFuncionario.getNome_Cargo()));

        }else

        if(jTextFieldcargo.getText().equals("")){

            ModFuncionario.setIdCargo(Integer.parseInt(jTextFieldCodigo.getText()));

            PreencherTabela_Cargo("select * from cargo where idCargo ='"+ModFuncionario.getIdCargo()+"'");

            ControlFuncionario.Consultar_CodCargo(ModFuncionario);
    ...
    Conexao.executaSQL(sql);
        ...
        try {
            ...
            do{
                dados.add(new Object [] {Conexao.rs.getString("idCargo"),Conexao.rs.getString("Nome_Cargo")});
