 ...
 * @author Lucas
 */
public class JI_Formacao extends javax.swing.JInternalFrame {
   ...
   Cadastro_FuncionarioVO ModFuncionario = new Cadastro_FuncionarioVO();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTextFieldformacao, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        ModFuncionario.setNome_Formacao(jTextFieldformacao.getText());

        ControlFuncionario.Cadastrar_Formacao(ModFuncionario);
    ...
    private void jButtonPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesquisarActionPerformed
        ...
        if(jTextFieldCodigo.getText().equals("")){
            ...
            PreencherTabela_Formacao("select * from formacao where Nome_Formacao like'%"+ModFuncionario.getNome_Formacao()+"%'");

            ControlFuncionario.Consultar_NomeFormacao(ModFuncionario);

            jTextFieldCodigo.setText(String.valueOf(ModFuncionario.getIdFormacao()));
            jTextFieldformacao.setText(String.valueOf(ModFuncionario.getNome_Formacao()));

        }else

        if(jTextFieldformacao.getText().equals("")){

            ModFuncionario.setIdFormacao(Integer.parseInt(jTextFieldCodigo.getText()));

            PreencherTabela_Formacao("select * from formacao where idFormacao ='"+ModFuncionario.getIdFormacao()+"'");

            ControlFuncionario.Consultar_CodFormacao(ModFuncionario);
    ...
    public void PreencherTabela_Formacao (String sql){
        
        Conexao.conexao();
        ArrayList dados = new ArrayList();
        
        String[] Colunas = new String[]{"Código", "Nome Formacao"};
    ...
    Conexao.executaSQL(sql);
        ...
        try {
            ...
            do{
                dados.add(new Object [] {Conexao.rs.getString("idFormacao"),Conexao.rs.getString("Nome_Formacao")});
